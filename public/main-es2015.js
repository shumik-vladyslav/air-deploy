...
/***/ "./node_modules/raw-loader/index.js!./src/app/shared/components/modals/modal-video/modal-video.component.html":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/shared/components/modals/modal-video/modal-video.component.html ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<mat-video *ngIf=\"type === 'video'\"\n  src=\"assets/examples/video/y2mate.com-gotye_somebody_that_i_used_to_know_feat_kimbra_official_music_video_8UVNT4wvIGY_720p.mp4\"\n  type=\"video/mp4\"></mat-video>\n\n<mat-basic-audio-player *ngIf=\"type === 'audio' && !list\" [audioUrl]=\"msbapAudioUrl\" [title]=\"msbapTitle\"\n  [displayTitle]=\"msbapDisplayTitle\" [displayVolumeControls]=\"msaapDisplayVolumeControls\"></mat-basic-audio-player>\n\n<mat-advanced-audio-player *ngIf=\"type === 'audio' && list\" [playlist]=\"msaapPlaylist\"\n  [displayTitle]=\"msaapDisplayTitle\" [displayPlaylist]=\"msaapDisplayPlayList\" [pageSizeOptions]=\"pageSizeOptions\"\n  [displayVolumeControls]=\"msaapDisplayVolumeControls\" [expanded]=\"true\"></mat-advanced-audio-player>"
...
let AppComponent = class AppComponent {
    constructor(title, router, activeRoute, routePartsService, themeService, layout, renderer, loadingService, chRef) {
        this.title = title;
        this.router = router;
        ...
        this.appTitle = 'Egret';
        this.pageTitle = '';
        this.loadingService.show.subscribe(res => {
            this.loading = res;
    ...
    changePageTitle() {
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"])).subscribe((routeChange) => {
...
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/esm2015/ngx-translate-core.js");
/* harmony import */ var _ngx_translate_http_loader__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @ngx-translate/http-loader */ "./node_modules/@ngx-translate/http-loader/esm2015/ngx-translate-http-loader.js");
/* harmony import */ var _shared_services_error_handler_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./shared/services/error-handler.service */ "./src/app/shared/services/error-handler.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        ...
        providers: [
            { provide: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ErrorHandler"], useClass: _shared_services_error_handler_service__WEBPACK_IMPORTED_MODULE_14__["ErrorHandlerService"] },
...
const rootRouterConfig = [
    ...
    },
    {
        ...
        children: [
            {
                path: 'home',
                loadChildren: () => __webpack_require__.e(/*! import() | views-others-others-module */ "views-others-others-module").then(__webpack_require__.bind(null, /*! ./views/others/others.module */ "./src/app/views/others/others.module.ts")).then(m => m.OthersModule),
...
let BottomSheetShareComponent = class BottomSheetShareComponent {
...
BottomSheetShareComponent.ctorParameters = () => [
...
module.exports = ".handle {\n  position: fixed;\n  bottom: 30px;\n  right: 30px;\n  z-index: 111; }\n\n#app-customizer {\n  position: fixed;\n  bottom: 0px;\n  top: 0;\n  right: 0;\n  min-width: 180px;\n  max-width: 280px;\n  z-index: 999; }\n\n#app-customizer .title {\n    text-transform: uppercase;\n    font-size: 12px;\n    font-weight: bold;\n    margin: 0 0 1rem; }\n\n#app-customizer .mat-card {\n    margin: 0;\n    border-radius: 0; }\n\n#app-customizer .mat-card-content {\n    padding: 1rem 1.5rem 2rem;\n    max-height: calc(100vh - 80px); }\n\n.pos-rel {\n  position: relative;\n  z-index: 99; }\n\n.pos-rel .olay {\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    background: rgba(0, 0, 0, 0.5);\n    z-index: 100; }\n\n.colors {\n  display: flex;\n  flex-wrap: wrap; }\n\n.colors .color {\n    position: relative;\n    width: 36px;\n    height: 36px;\n    display: inline-block;\n    border-radius: 50%;\n    margin: 8px;\n    text-align: center;\n    box-shadow: 0 4px 20px 1px rgba(0, 0, 0, 0.06), 0 1px 4px rgba(0, 0, 0, 0.03);\n    cursor: pointer; }\n\n.colors .color .active-icon {\n      position: absolute;\n      left: 0;\n      right: 0;\n      margin: auto;\n      top: 6px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
let CustomizerComponent = class CustomizerComponent {
    constructor(navService, layout, themeService, customizer, renderer) {
        ...
        this.customizer.openCustomizer.subscribe(val => {
            this.isCustomizerOpen = val;
        });
    }
    ngOnInit() {
...
EgretExampleViewerTemplateComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }
];
...
EgretExampleViewerComponent.ctorParameters = () => [
...
/* harmony import */ var app_shared_services_customizer_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! app/shared/services/customizer.service */ "./src/app/shared/services/customizer.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let HeaderSideComponent = class HeaderSideComponent {
    constructor(themeService, layout, translate, renderer, customizerService) {
        this.themeService = themeService;
        this.layout = layout;
    ...
    openCustomizer() {
        this.customizerService.openCustomizer.emit(true);
    }
    ngOnInit() {
        this.egretThemes = this.themeService.egretThemes;
        this.layoutConf = this.layout.layoutConf;
...
HeaderSideComponent.ctorParameters = () => [
    ...
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"] },
    { type: app_shared_services_customizer_service__WEBPACK_IMPORTED_MODULE_4__["CustomizerService"] }
];
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
    __metadata("design:type", Object)
...
HeaderSideComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_services_theme_service__WEBPACK_IMPORTED_MODULE_1__["ThemeService"],
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"],
        app_shared_services_customizer_service__WEBPACK_IMPORTED_MODULE_4__["CustomizerService"]])
], HeaderSideComponent);
...
/* harmony import */ var app_shared_services_customizer_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/shared/services/customizer.service */ "./src/app/shared/services/customizer.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let HeaderTopComponent = class HeaderTopComponent {
    constructor(layout, navService, themeService, translate, renderer, customizerService) {
        this.layout = layout;
        this.navService = navService;
        this.themeService = themeService;
        this.translate = translate;
...
HeaderTopComponent.ctorParameters = () => [
    ...
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"] },
    { type: app_shared_services_customizer_service__WEBPACK_IMPORTED_MODULE_5__["CustomizerService"] }
];
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
    __metadata("design:type", Object)
...
HeaderTopComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_services_layout_service__WEBPACK_IMPORTED_MODULE_4__["LayoutService"],
        ...
        _ngx_translate_core__WEBPACK_IMPORTED_MODULE_3__["TranslateService"],
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"],
        app_shared_services_customizer_service__WEBPACK_IMPORTED_MODULE_5__["CustomizerService"]])
], HeaderTopComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/esm2015/ngx-translate-core.js");
...
let AdminLayoutComponent = class AdminLayoutComponent {
    constructor(router, translate, themeService, layout, cdr) {
        this.router = router;
        this.translate = translate;
        this.themeService = themeService;
        this.layout = layout;
...
/***/ "./src/app/shared/components/modals/modal-video/modal-video.component.scss":
/*!*********************************************************************************!*\
  !*** ./src/app/shared/components/modals/modal-video/modal-video.component.scss ***!
  \*********************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3NoYXJlZC9jb21wb25lbnRzL21vZGFscy9tb2RhbC12aWRlby9tb2RhbC12aWRlby5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/shared/components/modals/modal-video/modal-video.component.ts":
/*!*******************************************************************************!*\
  !*** ./src/app/shared/components/modals/modal-video/modal-video.component.ts ***!
  \*******************************************************************************/
...
let ModalVideoComponent = class ModalVideoComponent {
        ...
        this.msaapPlaylist = [
            {
                ...
                link: 'assets/examples/audio/y2mate.com-gotye_somebody_that_i_used_to_know_feat_kimbra_official_music_video_8UVNT4wvIGY.mp3'
            },
            {
    ...
    ngOnInit() {
        if (!this.data.list) {
            this.msbapTitle = this.data.title;
            this.msbapAudioUrl = this.data.source;
            this.type = this.data.type;
            this.list = this.data.list;
            this.msbapDisplayTitle = true;
            this.msDisplayVolumeControls = true;
        }
    }
};
ModalVideoComponent.ctorParameters = () => [
...
ModalVideoComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-modal-video',
        template: __webpack_require__(/*! raw-loader!./modal-video.component.html */ "./node_modules/raw-loader/index.js!./src/app/shared/components/modals/modal-video/modal-video.component.html"),
        styles: [__webpack_require__(/*! ./modal-video.component.scss */ "./src/app/shared/components/modals/modal-video/modal-video.component.scss")]
    }),
...
/* harmony import */ var _header_side_header_side_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./header-side/header-side.component */ "./src/app/shared/components/header-side/header-side.component.ts");
/* harmony import */ var _sidebar_side_sidebar_side_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./sidebar-side/sidebar-side.component */ "./src/app/shared/components/sidebar-side/sidebar-side.component.ts");
/* harmony import */ var _header_top_header_top_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./header-top/header-top.component */ "./src/app/shared/components/header-top/header-top.component.ts");
/* harmony import */ var _sidebar_top_sidebar_top_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./sidebar-top/sidebar-top.component */ "./src/app/shared/components/sidebar-top/sidebar-top.component.ts");
...
/* harmony import */ var _layouts_admin_layout_admin_layout_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./layouts/admin-layout/admin-layout.component */ "./src/app/shared/components/layouts/admin-layout/admin-layout.component.ts");
/* harmony import */ var _layouts_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./layouts/auth-layout/auth-layout.component */ "./src/app/shared/components/layouts/auth-layout/auth-layout.component.ts");
/* harmony import */ var _notifications_notifications_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./notifications/notifications.component */ "./src/app/shared/components/notifications/notifications.component.ts");
/* harmony import */ var _sidenav_sidenav_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./sidenav/sidenav.component */ "./src/app/shared/components/sidenav/sidenav.component.ts");
/* harmony import */ var _breadcrumb_breadcrumb_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./breadcrumb/breadcrumb.component */ "./src/app/shared/components/breadcrumb/breadcrumb.component.ts");
/* harmony import */ var _services_app_confirm_app_confirm_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../services/app-confirm/app-confirm.component */ "./src/app/shared/services/app-confirm/app-confirm.component.ts");
/* harmony import */ var _services_app_loader_app_loader_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../services/app-loader/app-loader.component */ "./src/app/shared/services/app-loader/app-loader.component.ts");
/* harmony import */ var _button_loading_button_loading_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./button-loading/button-loading.component */ "./src/app/shared/components/button-loading/button-loading.component.ts");
/* harmony import */ var _egret_sidebar_egret_sidebar_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./egret-sidebar/egret-sidebar.component */ "./src/app/shared/components/egret-sidebar/egret-sidebar.component.ts");
/* harmony import */ var _bottom_sheet_share_bottom_sheet_share_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./bottom-sheet-share/bottom-sheet-share.component */ "./src/app/shared/components/bottom-sheet-share/bottom-sheet-share.component.ts");
/* harmony import */ var _example_viewer_example_viewer_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./example-viewer/example-viewer.component */ "./src/app/shared/components/example-viewer/example-viewer.component.ts");
/* harmony import */ var _example_viewer_template_example_viewer_template_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./example-viewer-template/example-viewer-template.component */ "./src/app/shared/components/example-viewer-template/example-viewer-template.component.ts");
/* harmony import */ var _modals_modal_video_modal_video_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./modals/modal-video/modal-video.component */ "./src/app/shared/components/modals/modal-video/modal-video.component.ts");
/* harmony import */ var mat_video__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! mat-video */ "./node_modules/mat-video/fesm2015/mat-video.js");
/* harmony import */ var ngx_audio_player__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ngx-audio-player */ "./node_modules/ngx-audio-player/fesm2015/ngx-audio-player.js");
...
const components = [
    _header_top_header_top_component__WEBPACK_IMPORTED_MODULE_14__["HeaderTopComponent"],
    _sidebar_top_sidebar_top_component__WEBPACK_IMPORTED_MODULE_15__["SidebarTopComponent"],
    ...
    _sidebar_side_sidebar_side_component__WEBPACK_IMPORTED_MODULE_13__["SidebarSideComponent"],
    _header_side_header_side_component__WEBPACK_IMPORTED_MODULE_12__["HeaderSideComponent"],
    ...
    _modals_modal_video_modal_video_component__WEBPACK_IMPORTED_MODULE_29__["ModalVideoComponent"]
];
let SharedComponentsModule = class SharedComponentsModule {
    constructor(library) {
        library.addIconPacks(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_33__["fas"]);
        library.addIcons(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_33__["faCoffee"]);
    }
};
SharedComponentsModule.ctorParameters = () => [
    { type: _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_32__["FaIconLibrary"] }
];
SharedComponentsModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        imports: [
            ...
            mat_video__WEBPACK_IMPORTED_MODULE_30__["MatVideoModule"],
            ngx_audio_player__WEBPACK_IMPORTED_MODULE_31__["NgxAudioPlayerModule"],
            _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_32__["FontAwesomeModule"]
        ],
        declarations: components,
        entryComponents: [_services_app_confirm_app_confirm_component__WEBPACK_IMPORTED_MODULE_22__["AppComfirmComponent"], _services_app_loader_app_loader_component__WEBPACK_IMPORTED_MODULE_23__["AppLoaderComponent"], _bottom_sheet_share_bottom_sheet_share_component__WEBPACK_IMPORTED_MODULE_26__["BottomSheetShareComponent"], _modals_modal_video_modal_video_component__WEBPACK_IMPORTED_MODULE_29__["ModalVideoComponent"]],
        exports: components
    }),
    __metadata("design:paramtypes", [_fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_32__["FaIconLibrary"]])
...
let SidebarSideComponent = class SidebarSideComponent {
    constructor(navService, themeService, layout) {
        this.navService = navService;
        this.themeService = themeService;
        this.layout = layout;
    }
...
EgretHighlightDirective.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"] },
...
/* harmony import */ var _invoices__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./invoices */ "./src/app/shared/inmemory-db/invoices.ts");
/* harmony import */ var _todo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todo */ "./src/app/shared/inmemory-db/todo.ts");
...
module.exports = ".search-bar-wide.open {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 64px;\n  z-index: 999; }\n  .search-bar-wide.open .search-icon-btn {\n    display: none; }\n  .search-bar-wide.open div {\n    display: flex; }\n  .search-bar-wide.open .search-close {\n    display: block; }\n  .search-bar-wide div {\n  display: none;\n  height: 100%;\n  width: 100%; }\n  .search-bar-wide div input {\n    height: 100%;\n    width: 100%;\n    border: 0;\n    outline: 0;\n    padding: 0;\n    font-weight: 700;\n    padding-left: 15px; }\n  .search-bar-wide .search-close {\n  display: none;\n  position: absolute;\n  top: 20px;\n  right: 15px;\n  cursor: pointer; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
SearchInputOverComponent.ctorParameters = () => [
...
let CustomizerService = class CustomizerService {
    constructor(router, layout) {
        this.router = router;
        this.layout = layout;
        this.openCustomizer = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"];
        this.colors = [
            {
                class: "black",
                active: false
...
let ErrorHandlerService = class ErrorHandlerService extends _angular_core__WEBPACK_IMPORTED_MODULE_0__["ErrorHandler"] {
...
let LayoutService = class LayoutService {
    ...
    setLayoutFromQuery() {
        let layoutConfString = Object(_helpers_url_helper__WEBPACK_IMPORTED_MODULE_2__["getQueryParam"])('layout');
        try {
...
/***/ "./src/app/shared/services/main/campaign.service.ts":
/*!**********************************************************!*\
  !*** ./src/app/shared/services/main/campaign.service.ts ***!
  \**********************************************************/
...
let CampaignService = class CampaignService {
    constructor(http) {
        this.http = http;
        this.url = 'http://swagger.dashboard.api.spotcheck.airplaycontrol.com:10080/api';
    }
    getCampaignsList() {
        return this.http.get(this.url + `/Campaigns`);
    }
    getCampaign(uuid) {
        return this.http.get(this.url + `/Campaigns/${uuid}`);
    }
    getPlaysStatistics() {
        return this.http.get(this.url + `/Plays/Statistics`);
    }
    getCompaignStatistics(uuid) {
        return this.http.get(this.url + `/Campaigns/${uuid}/Statistics`);
    }
    getCompaignFlights(uuid) {
        return this.http.get(this.url + `/Campaigns/${uuid}/Flights`);
    }
    getCompaignPlaysStations(uuid) {
        return this.http.get(this.url + `/Campaigns/${uuid}/Plays/Stations`);
    }
    getCompaignPlaysStationsWithPlaysCount(uuid) {
        return this.http.get(this.url + `/Campaigns/${uuid}/Plays/StationsWithPlaysCount`);
    }
};
    ...
    constructor() {
        this.plainMenu = [
            ...
            },
            {
                ...
                type: "link",
                tooltip: "Post-Evaluation",
                icon: "format_list_bulleted",
                state: "/home/post-evaluation"
            },
            {
                name: "Audio Logger",
                type: "link",
                tooltip: "Audio Logger",
                icon: "volume_up",
                state: "/home/audio-logger"
            },
            {
                name: "Report",
                type: "link",
...
let ThemeService = class ThemeService {
    ...
    // *********** ONLY FOR DEMO **********
    setThemeFromQuery() {
        let themeStr = Object(_helpers_url_helper__WEBPACK_IMPORTED_MODULE_2__["getQueryParam"])('theme');
        try {
...
let SharedMaterialModule = class SharedMaterialModule {
};
...
/* harmony import */ var _directives_shared_directives_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./directives/shared-directives.module */ "./src/app/shared/directives/shared-directives.module.ts");
/* harmony import */ var _services_main_campaign_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./services/main/campaign.service */ "./src/app/shared/services/main/campaign.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
SharedModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        ...
        providers: [
            ...
            _services_main_campaign_service__WEBPACK_IMPORTED_MODULE_11__["CampaignService"]
        ],
        exports: [
            _components_shared_components_module__WEBPACK_IMPORTED_MODULE_8__["SharedComponentsModule"],
            _pipes_shared_pipes_module__WEBPACK_IMPORTED_MODULE_9__["SharedPipesModule"],
...
module.exports = __webpack_require__(/*! C:\Users\User\Documents\GitHub\SpotCheck_V3_Client\src\main.ts */"./src/main.ts");
