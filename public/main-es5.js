...
var CustomizerComponent = /** @class */ (function () {
    function CustomizerComponent(navService, layout, themeService, customizer, renderer) {
        ...
        this.customizer.openCustomizer.subscribe(function (val) {
            _this.isCustomizerOpen = val;
        });
    }
...
var HeaderSideComponent = /** @class */ (function () {
    function HeaderSideComponent(themeService, layout, translate, renderer, customizerService) {
        this.themeService = themeService;
        this.layout = layout;
    ...
    HeaderSideComponent.prototype.openCustomizer = function () {
...
var HeaderTopComponent = /** @class */ (function () {
    function HeaderTopComponent(layout, navService, themeService, translate, renderer, customizerService) {
        this.layout = layout;
        this.navService = navService;
        this.themeService = themeService;
        this.translate = translate;
    ...
    HeaderTopComponent.prototype.openCustomizer = function () {
        this.customizerService.openCustomizer.emit(true);
    };
...
var ModalVideoComponent = /** @class */ (function () {
    function ModalVideoComponent(dialogRef, data) {
    ...
    ModalVideoComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    ModalVideoComponent.prototype.ngOnInit = function () {
        if (!this.data.list) {
    ...
    ModalVideoComponent.ctorParameters = function () { return [
...
/* harmony import */ var mat_video__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! mat-video */ "./node_modules/mat-video/fesm5/mat-video.js");
/* harmony import */ var ngx_audio_player__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ngx-audio-player */ "./node_modules/ngx-audio-player/fesm5/ngx-audio-player.js");
...
var SharedComponentsModule = /** @class */ (function () {
    function SharedComponentsModule(library) {
...
var CampaignService = /** @class */ (function () {
    ...
    CampaignService.prototype.getCampaignsList = function () {
        return this.http.get(this.url + "/Campaigns");
    };
    CampaignService.prototype.getCampaign = function (uuid) {
        return this.http.get(this.url + ("/Campaigns/" + uuid));
    };
    CampaignService.prototype.getPlaysStatistics = function () {
        return this.http.get(this.url + "/Plays/Statistics");
    };
    CampaignService.prototype.getCompaignStatistics = function (uuid) {
        return this.http.get(this.url + ("/Campaigns/" + uuid + "/Statistics"));
    };
    CampaignService.prototype.getCompaignFlights = function (uuid) {
        return this.http.get(this.url + ("/Campaigns/" + uuid + "/Flights"));
    };
    CampaignService.prototype.getCompaignPlaysStations = function (uuid) {
        return this.http.get(this.url + ("/Campaigns/" + uuid + "/Plays/Stations"));
    };
    CampaignService.prototype.getCompaignPlaysStationsWithPlaysCount = function (uuid) {
